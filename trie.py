# The following code is modified by Xin He from the code written by Bdimmick
# The original code from Bdimmick is available at https://github.com/bdimmick/python-trie/blob/master/trie.py
